...
def make_logger(parsed, logdir, step, config):
  ...
  logger = embodied.Logger(step, [
      dreamerv3.embodied.logger.TerminalOutput(config.filter),
      dreamerv3.embodied.logger.JSONLOutput(logdir, 'metrics.jsonl'),
      dreamerv3.embodied.logger.JSONLOutput(logdir, 'scores.jsonl', 'episode/score'),
      dreamerv3.embodied.logger.TensorBoardOutput(logdir),
